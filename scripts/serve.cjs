...
const allowed = new Set(['index.html','styles.css','app.js','logic.js','data.js','favicon.svg','Уголовный кодекс РО.txt','Процессуальный кодекс РО.txt','Конституция РО.txt']);
